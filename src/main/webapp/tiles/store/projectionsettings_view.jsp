...
<table border="0" cellspacing="0" align="center">
	...
	<tr>
			...
			<table id="editFormTable" border="0" cellpadding="6" cellspacing="0" colspan="0" cellspan="0">
				<tr class="editFormOddRow">
                    ...
                    <td align="left" class="value">
                    	<s:if test="distributionType != null">
                    		<s:text name="%{'distributionType.'+distributionType}" />
                    	</s:if>
                    </td>
				</tr>
			</table>
	   ...
	   <table border="0" cellpadding="1" cellspacing="5" colspan="0" cellspan="0">
	   	<tr><td><s:submit action="store_show" key="back.button" theme="simple" cssClass="button"/></td></tr>
	  </table> 
	  </s:form>                   
	  </td>
    </tr>
