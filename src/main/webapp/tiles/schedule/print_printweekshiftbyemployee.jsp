...
<center>
<h4><s:if test="!inTimeOnly"><s:text name="schedule.printshift.weekly.byemployee.title" /></s:if><s:else><s:text name="schedule.printshift.weekly.byemployee_in_time.title" /></s:else> - <s:text name='schedule.printshift.weekdayselector.selectedweek.dateformat'><s:param value='weekDaySelector.startingWeekDay'/></s:text></h4>
...
<table class="printScheduleMainTable" id="printScheduleMainTable" cellpadding="1" cellspacing="0">	
	...
	<s:iterator id="employee" value="weeklyScheduleEmployees" status="itEmployeeStatus">
		<tr>
			...
			<td class="printSchedulePositionTotalHours">&nbsp;</td>			
			</s:iterator>							
