...
<center>
	<h4><s:if test="!inTimeOnly"><s:text name="schedule.printshift.daily.byemployee.title" /></s:if><s:else><s:text name="schedule.printshift.daily.byemployee_in_time.title" /></s:else>&nbsp;-&nbsp;<s:text name='schedule.printshift.daily.weekday.dateformat'><s:param value='weekDaySelector.selectedDay'/></s:text></h4>
