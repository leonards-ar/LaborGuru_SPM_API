									...
									<td>
										<table border="0" cellpadding="1" cellspacing="2">
											<tr>
												...
												<td align="right"><s:submit id="copyButton" onclick="return confirmCopySchedule(this, '%{getText('schedule.addshift.copy.schedule.confirm.msg')}');" key="schedule.addshift.copy.button" action="addweeklyshiftbyposition_copySchedule" theme="simple" cssClass="button"/></td>
											</tr>
										</table>
									</td>
								</tr>								
