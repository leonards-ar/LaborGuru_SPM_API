/*
 * File name: FixedClosingPrepareAction.java
 ...
 *
 */
public class FixedClosingPrepareAction extends	StorePositionDayOfWeekDataBaseAction {
	 ...
	 * 
	 */
	public FixedClosingPrepareAction() {
	}
	...
	protected String getValidationErrorMessageKey() {
		return "error.storeoperations.fixedclosing.value.invalid";
	}
	...
	protected String getValueToShow(DayOfWeekData dayOfWeekData) {
		return doubleToDisplayDouble(dayOfWeekData.getFixedClosing(), 2);
	}
	...
	protected void setDayOfWeekDataValue(DayOfWeekData dayOfWeekData, String value) {
		dayOfWeekData.setFixedClosing(displayDoubleToDouble(value));
	}
