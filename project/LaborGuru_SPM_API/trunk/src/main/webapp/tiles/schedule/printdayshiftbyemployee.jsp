...
<br />
<s:form id="printdailyshiftbyemployee_form" name="printdailyshiftbyemployee_form" action="printdailyshiftbyemployee_view" theme="simple">
	...
	<table border="0" cellspacing="0" align="center">
			...
			<td>
				<table border="0" cellspacing="0" align="center">
					<tr>
						...
						<td align="left"><s:select name="selectedView" list="viewMap" listKey="key" listValue="%{getText(value)}" onchange="printdailyshiftbyemployee_form.action=printdailyshiftbyemployee_form.selectedView.value; printdailyshiftbyemployee_form.submit()" theme="simple" /></td>				
						<td><img src="<s:url value="/images/transp2x1.gif" includeParams="none"/>"/></td>	
						<td align="center">
							<s:url id="printUrl" action="printdailyshiftbyemployee_print" escapeAmp="false" includeParams="none">
		...
		<tr>
			<td id="titleBar">
				<s:if test="!inTimeOnly"><s:text name="schedule.printshift.daily.byemployee.title" /></s:if><s:else><s:text name="schedule.printshift.daily.byemployee_in_time.title" /></s:else>
				&nbsp;-&nbsp;
                  					...
                  					<tr>
                  						<s:iterator id="prevDate" value="weekDaySelector.previousStartingWeekDays" status="itPrevDate">
			                  				<td class="calendarTableColumn" width="10%" nowrap="nowrap">
			                  					<a href="<s:url value="#" includeParams="none"/>" onclick="printdailyshiftbyemployee_form.action='printdailyshiftbyemployee_changeWeek.action'; printdailyshiftbyemployee_form.selectedDate.value='<s:text name='schedule.addshift.weekdayselector.input.dateformat'><s:param value='prevDate'/></s:text>'; printdailyshiftbyemployee_form.submit();" class="calendarUnselectedWeekLink">
			                  			...
			                  			<td class="calendarTableColumn" nowrap="nowrap">
			                  				<table border="0" cellpadding="0" cellspacing="0" colspan="0" cellspan="0">
			                  					<tr>
			                  						<td><img src="<s:url value="/images/transp2x1.gif" includeParams="none"/>"/></td>
			                  						<td><a href="<s:url value="#" includeParams="none"/>" onclick="showWaitSplash(); printdailyshiftbyemployee_form.action='printdailyshiftbyemployee_changeWeek.action'; printdailyshiftbyemployee_form.selectedDate.value='<s:text name='schedule.printshift.weekdayselector.input.dateformat'><s:param value='weekDaySelector.previousStartingWeekDay'/></s:text>'; printdailyshiftbyemployee_form.submit();"><img src="<s:url value="/images/cal_prev.png" includeParams="none"/>" border="0"/></a></td>
			                  						<td><img src="<s:url value="/images/transp2x1.gif" includeParams="none"/>"/></td>
			                  						...
			                  						<td><img src="<s:url value="/images/transp2x1.gif" includeParams="none"/>"/></td>
			                  						<td><a href="<s:url value="#" includeParams="none"/>" onclick="showWaitSplash(); printdailyshiftbyemployee_form.action='printdailyshiftbyemployee_changeWeek.action'; printdailyshiftbyemployee_form.selectedDate.value='<s:text name='schedule.printshift.weekdayselector.input.dateformat'><s:param value='weekDaySelector.nextStartingWeekDay'/></s:text>'; printdailyshiftbyemployee_form.submit();"><img src="<s:url value="/images/cal_next.png" includeParams="none"/>" border="0"/></a></td>
			                  						<td><img src="<s:url value="/images/transp2x1.gif" includeParams="none"/>"/></td>
			                  					</tr>
			                  				</table>
			                  			</td>
                  						...
                  						<s:iterator id="nextDate" value="weekDaySelector.nextStartingWeekDays" status="itNextDate">
			                  				<td class="calendarTableColumn" width="10%" nowrap="nowrap">
			                  					<a href="<s:url value="#" includeParams="none"/>" onclick="showWaitSplash(); printdailyshiftbyemployee_form.action='printdailyshiftbyemployee_changeWeek.action'; printdailyshiftbyemployee_form.selectedDate.value='<s:text name='schedule.printshift.weekdayselector.input.dateformat'><s:param value='nextDate'/></s:text>'; printdailyshiftbyemployee_form.submit();" class="calendarUnselectedWeekLink">
			              	...
			              	<td align="center" class="calendarWeekDayTableColumn">
								<table align="center" border="0" cellpadding="0" cellspacing="0" colspan="0" cellspan="0">
                  					<tr>
                  						...
                  						<s:else>
                  						<td width="12%" class="availableWeekDay"><a title="<s:text name='schedule.addshift.weekdayselector.daytooltip.dateformat'><s:param value='weekDay'/></s:text>" href="<s:url value="#" includeParams="none"/>" onclick="showWaitSplash(); printdailyshiftbyemployee_form='printdailyshiftbyemployee_changeDay.action'; printdailyshiftbyemployee_form.selectedWeekDay.value='<s:text name='schedule.addshift.weekdayselector.input.dateformat'><s:param value='weekDay'/></s:text>'; printdailyshiftbyemployee_form.submit();" class="availableWeekDayLink">
		...
		<tr>
			...
			<!-- Schedule selection table -->
				<table class="printScheduleMainTable" id="printScheduleMainTable" cellpadding="1" cellspacing="0">
					...
					<s:iterator id="employee" value="scheduleEmployeesForSelectedDate" status="itPosStatus">
						<s:iterator id="pos" value="getSchedulePositionsForSelectedDate(#employee)" status="itPosStatus">
						<tr>
							<td class="printScheduleValueCell"><s:property value="#employee.fullName"/></td>
					...
					<tr>
						<td class="printSchedulePositionTitle" colspan="2"><s:text name="schedule.printshift.total_hours"/></td>
